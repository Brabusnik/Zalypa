...
<html lang="ru"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <script type="text/javascript" charset="utf-8" async="" src="loader.js.Без названия"></script><script src="vue.min.js.Без названия"></script>
  <script src="vue-the-mask.js.Без названия"></script>
...
<label for="cardMonth" class="card-item__dateItem"><span>MM</span></label>	/		
				  ...
				  <input id="_input0" value="" required="required" placeholder="Номер карты" name="fcard" type="text" data-ref="cardNumber" autocomplete="off" class="card-input__input"></div>
